    ...
    public function findPrevious(
        ...
        for ($i = $start; $i >= $end; $i--) {
            ...
            if ($local === true) {
                ...
                } elseif (isset($this->_tokens[$i]['bracket_opener']) === true
                    && $i === $this->_tokens[$i]['bracket_closer']
                ) {
                    $i = $this->_tokens[$i]['bracket_opener'];
                } elseif (isset($this->_tokens[$i]['parenthesis_opener']) === true
    ...
    public function findEndOfStatement($start, $ignore = null)
    {
        ...
        for ($i = $start; $i < $this->numTokens; $i++) {
            ...
            if (isset($this->_tokens[$i]['scope_closer']) === true
                ...
                $i = $this->_tokens[$i]['scope_closer'];
            } elseif (isset($this->_tokens[$i]['bracket_closer']) === true
                && $i === $this->_tokens[$i]['bracket_opener']
            ) {
                $i = $this->_tokens[$i]['bracket_closer'];
            } elseif (isset($this->_tokens[$i]['parenthesis_closer']) === true
                && $i === $this->_tokens[$i]['parenthesis_opener']
            ) {
                $i = $this->_tokens[$i]['parenthesis_closer'];
            }
